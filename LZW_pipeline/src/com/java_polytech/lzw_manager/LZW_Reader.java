...
public class LZW_Reader implements IReader {
    private static final String READER_BUFFER_SIZE = "BUFFER_SIZE";
    ...
    public RC setConfig(String cfgFileName) {
        ...
        String bufferSizeStr = config.GetValue(READER_BUFFER_SIZE);
    ...
    public RC run() {
        ...
        do {
            try {
                readenPart = readerInputStream.readNBytes(bytesTmp, 0, bufferSize);
            } catch (IOException e) {
