...
public class LZW_Writter implements IWriter {
    private static final String WRITER_BUFFER_SIZE = "BUFFER_SIZE";
    ...
    public RC setConfig(String cfgFileName) {
        ...
        String bufferSizeStr = config.GetValue(WRITER_BUFFER_SIZE);
